...
const CartongessistaIndexPage: React.FC<PageProps> = () => {
  return (
    <div className="gypso-page">
      ...
      <section className="gypso-hero">
        ...
        <img src="/gypso-icon.png" alt="Cartongessista App Icon" className="gypso-hero-logo" />

        <h1 className="gypso-hero-title">Cartongessista (GYPSO)</h1>
        <p className="gypso-hero-subtitle">
          Calcolo Professionale Cartongesso, Editor CAD Nativo 2D, Ottimizzazione Sfrido Reale e Computo Metrico Preventivabile in PDF.
        </p>
        ...
        <div className="gypso-hero-actions">
          ...
          <Link to="/cartongessista/privacy" className="gypso-btn-secondary">
            <Shield size={18} /> Informativa Privacy
          </Link>
          <Link to="/cartongessista/terms" className="gypso-btn-secondary">
        ...
        <div className="gypso-cad-mockup">
          <div className="gypso-cad-header">
            ...
            <div style={{ fontSize: "0.85rem", color: "var(--gypso-text-secondary)", fontFamily: "monospace" }}>
              Cartongessista CAD Canvas 2D — Progetto: Soggiorno_Residenziale.cart
            </div>
        ...
        <div className="gypso-features-grid">
          <div className="gypso-card gypso-feature-card">
            ...
            <p className="gypso-feature-text">
              Inserisci finestre, porte, velette, nicchie, gole luminose, bocchette dell'aria condizionata e pilastri ricalcolando automaticamente la superficie netta.
            </p>
          </div>
          ...
          <div className="gypso-card gypso-feature-card">
            ...
            <h3 className="gypso-feature-title">Privacy by Design & Zero-Cloud</h3>
            <p className="gypso-feature-text">
              Nessun tracciamento dati su server proprietari. Piena conformità al Regolamento Europeo GDPR (Art. 25) e sandbox locale protetta.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="specs" className="gypso-section">
        <h2 className="gypso-section-title">Architettura & Prestazioni</h2>
        <p className="gypso-section-desc">
      ...
      <section className="gypso-section">
        <div className="gypso-privacy-banner">
          ...
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            <Link to="/cartongessista/privacy" className="gypso-btn-primary">
      ...
      <footer className="gypso-footer">
        <div style={{ display: "flex", gap: "16px", flexWrap: "wrap", justifyContent: "center", marginBottom: "12px" }}>
          <Link to="/cartongessista/privacy" style={{ color: "var(--gypso-cyan)", textDecoration: "none", fontSize: "0.85rem" }}>
            Informativa Privacy
          </Link>
          <span style={{ color: "var(--gypso-text-muted)" }}>•</span>
          <Link to="/cartongessista/terms" style={{ color: "var(--gypso-cyan)", textDecoration: "none", fontSize: "0.85rem" }}>
        ...
        <p>© {new Date().getFullYear()} Cartongessista (GYPSO). Tutti i diritti riservati.</p>
      </footer>
    </div>
  )
}

export default CartongessistaIndexPage

export const Head: HeadFC = () => (
  <>
    <title>Cartongessista (GYPSO) — Calcolo Professionale Cartongesso & CAD 2D</title>
    <meta name="description" content="Cartongessista (GYPSO) è l'applicazione professionale per cartongessisti, artigiani e geometri. Editor CAD 2D, calcolo dello sfrido reale e preventivi PDF." />
  </>
)
